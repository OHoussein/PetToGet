...
/**
 * https://github.com/android/compose-samples/blob/92f2f16e4e63fa0e4418f660dde9e9558674cee5/Jetcaster/app/src/main/java/com/example/jetcaster/util/Pager.kt
 */
...
class PagerState(
    ...
    suspend fun selectPage() {
        val targetPage = currentPage - currentPageOffset.roundToInt()
        val updated = targetPage != currentPage
        currentPage = targetPage
        snapToOffset(0f)
        selectionState = SelectionState.Selected
        if (updated) onPageChanged?.invoke(currentPage)
    }
